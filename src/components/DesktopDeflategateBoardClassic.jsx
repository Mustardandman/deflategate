        ...
        <div className="flex items-center justify-between w-full lg:w-auto gap-4">
          ...
          {toggleDesktopUi && (
            <button 
              ...
              className="bg-emerald-950/80 hover:bg-emerald-900 border border-emerald-500/80 text-emerald-300 font-bold px-3 py-2.5 rounded-xl text-xs shadow flex items-center gap-1.5 cursor-pointer transition-all shrink-0"
              title="Switch to New Arena Tabletop Layout"
            >
              <span>🏟️</span> Arena UI
            </button>
          )}
        </div>
